...
# region Defininition for environmnt config ---------------------------------------------------------------------------
...
@configclass
class BouncerGo1EnvCfg(DirectRLEnvCfg):
...
# region Definition for the environment -------------------------------------------------------------------------------
...
# @configclass
class BouncerGo1Env(DirectRLEnv):
    cfg: BouncerGo1EnvCfg

    def __init__(self, cfg: BouncerGo1EnvCfg, render_mode: str | None = None, **kwargs):
    ...
    def _reset_idx(self, env_ids: torch.Tensor | None):
        ...
        # print('Command ', env_ids, self._commands[env_ids])
...
# endregion Definition for the environment ----------------------------------------------------------------------------



# region Definition for the agent -------------------------------------------------------------------------------------

from isaaclab_rl.rsl_rl import RslRlOnPolicyRunnerCfg, RslRlPpoActorCriticCfg, RslRlPpoAlgorithmCfg


@configclass
class BouncerGo1PPORunnerCfg(RslRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 300
    save_interval = 50
    experiment_name = "bouncer"
...
# endregion Definition for the agent ----------------------------------------------------------------------------------